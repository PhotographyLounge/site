<template>
	<main>
		<article id="5e3ea028-0697-4f95-89e4-0ed44d5f8b15" class="page sans">
			<header>
				<div class="page-header-icon undefined">
					<span class="icon">📸</span>
				</div>
				<h1 class="page-title">Photography Lounge Updates</h1>
			</header>
			<div class="page-body">
				<table class="collection-content">
					...
					<tbody>
						<tr id="c3d58094-156d-4a78-8470-27d493992cb9">
							<td class="cell-title">
								<a href="/updates/v2-1">V2.1</a>
							</td>
							<td class="cell-utmD"><time>@Jun 16, 2021 2:38 PM</time></td>
							<td class="cell-dNKx">
						...
						<tr id="f42aabae-6590-47e4-a372-f3f4625bff6b">
							<td class="cell-title">
								<a href="/updates/v1-v2">V1-V2</a>
							</td>
							<td class="cell-utmD"><time>@Jun 16, 2021 2:38 PM</time></td>
							<td class="cell-dNKx">
