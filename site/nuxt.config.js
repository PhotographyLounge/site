	...
	head: {
		...
		meta: [
			...
			{ name: 'viewport', content: 'width=device-width, initial-scale=1' },
			{
				...
				name: 'description',
				content:
					'Discord Partnered Community striving to create a welcoming and inclusive space for Photographers to share their work, get critiqued, and have a good time!',
			},
		],
